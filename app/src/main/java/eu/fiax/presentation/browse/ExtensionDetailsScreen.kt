...
import eu.fiax.domain.extension.interactor.ExtensionSourceItem
...
import eu.fiax.presentation.more.settings.widget.TrailingWidgetBuffer
import eu.fiax.R
import eu.fiax.faxyomi.extension.model.Extension
import eu.fiax.faxyomi.source.ConfigurableSource
import eu.fiax.faxyomi.ui.browse.extension.details.ExtensionDetailsScreenModel
...
private fun DetailsHeader(
    ...
    Column {
        Column(
            ...
            val strippedPkgName = extension.pkgName.substringAfter("eu.fiax.faxyomi.extension.")
