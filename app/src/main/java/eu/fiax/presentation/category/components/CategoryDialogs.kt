...
import eu.fiax.core.preference.asToggleableState
...
fun ChangeCategoryDialog(
    ...
    if (initialSelection.isEmpty()) {
        AlertDialog(
            onDismissRequest = onDismissRequest,
            confirmButton = {
                faxyomi.presentation.core.components.material.TextButton(
                    onClick = {
                        onDismissRequest()
                        onEditCategories()
                    },
    ...
    AlertDialog(
        ...
        confirmButton = {
            Row {
                faxyomi.presentation.core.components.material.TextButton(onClick = {
                    onDismissRequest()
                    onEditCategories()
                }) {
                ...
                faxyomi.presentation.core.components.material.TextButton(onClick = onDismissRequest) {
                    Text(text = stringResource(MR.strings.action_cancel))
                }
                faxyomi.presentation.core.components.material.TextButton(
                    onClick = {
