...
import eu.fiax.domain.source.service.SourcePreferences.DataSaver
import eu.fiax.presentation.more.settings.Preference
import eu.fiax.presentation.more.settings.screen.advanced.ClearDatabaseScreen
import eu.fiax.presentation.more.settings.screen.debug.DebugInfoScreen
import eu.fiax.R
...
import eu.fiax.faxyomi.network.PREF_DOH_360
import eu.fiax.faxyomi.network.PREF_DOH_ADGUARD
import eu.fiax.faxyomi.network.PREF_DOH_ALIDNS
import eu.fiax.faxyomi.network.PREF_DOH_CLOUDFLARE
import eu.fiax.faxyomi.network.PREF_DOH_CONTROLD
import eu.fiax.faxyomi.network.PREF_DOH_DNSPOD
import eu.fiax.faxyomi.network.PREF_DOH_GOOGLE
import eu.fiax.faxyomi.network.PREF_DOH_MULLVAD
import eu.fiax.faxyomi.network.PREF_DOH_NJALLA
import eu.fiax.faxyomi.network.PREF_DOH_QUAD101
import eu.fiax.faxyomi.network.PREF_DOH_QUAD9
import eu.fiax.faxyomi.network.PREF_DOH_SHECAN
