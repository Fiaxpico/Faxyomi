...
import eu.fiax.presentation.category.visualName
import eu.fiax.presentation.more.settings.Preference
import eu.fiax.presentation.more.settings.widget.TriStateListDialog
...
import faxyomi.domain.library.service.LibraryPreferences.Companion.DEVICE_CHARGING
import faxyomi.domain.library.service.LibraryPreferences.Companion.DEVICE_NETWORK_NOT_METERED
import faxyomi.domain.library.service.LibraryPreferences.Companion.DEVICE_ONLY_ON_WIFI
import faxyomi.domain.library.service.LibraryPreferences.Companion.MANGA_HAS_UNREAD
import faxyomi.domain.library.service.LibraryPreferences.Companion.MANGA_NON_COMPLETED
import faxyomi.domain.library.service.LibraryPreferences.Companion.MANGA_NON_READ
import faxyomi.domain.library.service.LibraryPreferences.Companion.MANGA_OUTSIDE_RELEASE_PERIOD
import faxyomi.domain.library.service.LibraryPreferences.Companion.MARK_DUPLICATE_CHAPTER_READ_EXISTING
import faxyomi.domain.library.service.LibraryPreferences.Companion.MARK_DUPLICATE_CHAPTER_READ_NEW
