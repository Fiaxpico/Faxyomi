...
import eu.fiax.presentation.more.settings.widget.EditTextPreferenceWidget
import eu.fiax.presentation.more.settings.widget.InfoWidget
import eu.fiax.presentation.more.settings.widget.ListPreferenceWidget
import eu.fiax.presentation.more.settings.widget.MultiSelectListPreferenceWidget
import eu.fiax.presentation.more.settings.widget.PrefsHorizontalPadding
import eu.fiax.presentation.more.settings.widget.PrefsVerticalPadding
...
import eu.fiax.presentation.more.settings.widget.TitleFontSize
import eu.fiax.presentation.more.settings.widget.TrackingPreferenceWidget
import kotlinx.coroutines.launch
import faxyomi.presentation.core.components.BaseSliderItem
