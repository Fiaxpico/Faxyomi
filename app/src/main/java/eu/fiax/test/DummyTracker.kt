...
data class DummyTracker(
    ...
    override suspend fun update(
        track: eu.fiax.faxyomi.data.database.models.Track,
        didReadChapter: Boolean,
    ): eu.fiax.faxyomi.data.database.models.Track = track
    ...
    override suspend fun register(
        item: eu.fiax.faxyomi.data.database.models.Track,
        mangaId: Long,
    ) = Unit
    ...
    override suspend fun getMangaMetadata(
        track: faxyomi.domain.track.model.Track,
    ): eu.fiax.faxyomi.data.track.model.TrackMangaMetadata = eu.fiax.faxyomi.data.track.model.TrackMangaMetadata(
