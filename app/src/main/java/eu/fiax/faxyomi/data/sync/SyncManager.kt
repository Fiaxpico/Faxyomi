...
import eu.fiax.faxyomi.data.sync.service.SyncData
import eu.fiax.faxyomi.data.sync.service.SyncYomiSyncService
...
import faxyomi.data.manga.MangaMapper.mapManga
...
class SyncManager(
    ...
    private fun writeSyncDataToCache(context: Context, backup: Backup): Uri? {
        val cacheFile = File(context.cacheDir, "faxyomi_sync_data.proto.gz")
        return try {
