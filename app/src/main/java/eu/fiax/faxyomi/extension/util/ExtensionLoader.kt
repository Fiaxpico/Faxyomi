 ...
 * installer, so other variants of faxyomi and its forks can also use this extension.
 *
...
internal object ExtensionLoader {
    ...
    private const val EXTENSION_FEATURE = "faxyomi.extension"
    private const val METADATA_SOURCE_CLASS = "faxyomi.extension.class"
    private const val METADATA_SOURCE_FACTORY = "faxyomi.extension.factory"
    private const val METADATA_NSFW = "faxyomi.extension.nsfw"
    ...
    private suspend fun loadExtension(context: Context, extensionInfo: ExtensionInfo): LoadResult {
        ...
        val extName = pkgManager.getApplicationLabel(appInfo).toString().substringAfter("faxyomi: ")
