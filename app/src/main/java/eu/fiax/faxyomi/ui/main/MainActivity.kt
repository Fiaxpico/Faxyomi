package eu.fiax.faxyomi.ui.main
...
import eu.fiax.presentation.components.AppStateBanners
import eu.fiax.presentation.components.DownloadedOnlyBannerBackgroundColor
import eu.fiax.presentation.components.IncognitoModeBannerBackgroundColor
import eu.fiax.presentation.components.IndexingBannerBackgroundColor
import eu.fiax.presentation.more.settings.screen.ConfigureExhDialog
import eu.fiax.presentation.more.settings.screen.about.WhatsNewDialog
import eu.fiax.presentation.more.settings.screen.browse.ExtensionReposScreen
import eu.fiax.presentation.more.settings.screen.data.RestoreBackupScreen
import eu.fiax.presentation.util.AssistContentScreen
import eu.fiax.presentation.util.DefaultNavigatorScreenTransition
...
import eu.fiax.faxyomi.extension.api.ExtensionApi
...
import eu.fiax.faxyomi.ui.deeplink.DeepLinkScreen
...
import eu.fiax.faxyomi.ui.more.OnboardingScreen
import eu.fiax.faxyomi.util.system.dpToPx
import eu.fiax.faxyomi.util.system.isNavigationBarNeedsScrim
...
class MainActivity : BaseActivity() {
    ...
    private fun handleIntentAction(intent: Intent, navigator: Navigator): Boolean {
        ...
        val tabToOpen = when (intent.action) {
            ...
            Intent.ACTION_SEARCH, Intent.ACTION_SEND, "com.google.android.gms.actions.SEARCH_ACTION" -> {
                ...
                // or the Google-specific search intent (triggered by saying or typing "search *query* on *faxyomi*" in Google Search/Google Assistant)
            ...
            Intent.ACTION_VIEW -> {
                ...
                else if (intent.scheme == "faxyomi" && intent.data?.host == "add-repo") {
    ...
    companion object {
        const val INTENT_SEARCH = "eu.fiax.faxyomi.SEARCH"
