...
import eu.fiax.R
import eu.fiax.domain.DomainModule
import eu.fiax.domain.SYDomainModule
...
import eu.fiax.faxyomi.crash.CrashActivity
import eu.fiax.faxyomi.crash.GlobalExceptionHandler
import eu.fiax.faxyomi.data.coil.BufferedSourceFetcher
import eu.fiax.faxyomi.data.coil.MangaCoverFetcher
import eu.fiax.faxyomi.data.coil.MangaCoverKeyer
import eu.fiax.faxyomi.data.coil.MangaKeyer
import eu.fiax.faxyomi.data.coil.PagePreviewFetcher
import eu.fiax.faxyomi.data.coil.PagePreviewKeyer
...
import eu.fiax.faxyomi.di.AppModule
import eu.fiax.faxyomi.di.InjektKoinBridge
import eu.fiax.faxyomi.di.PreferenceModule
import eu.fiax.faxyomi.di.SYPreferenceModule
import eu.fiax.faxyomi.di.importModule
import eu.fiax.faxyomi.di.initExpensiveComponents
...
import faxyomi.presentation.widget.WidgetManager
    ...
    override fun newImageLoader(context: Context): ImageLoader {
        return ImageLoader.Builder(this).apply {
            ...
            components {
                ...
                // Decoder.Factory
                add(faxyomiImageDecoder.Factory())
                // Fetcher.Factory
