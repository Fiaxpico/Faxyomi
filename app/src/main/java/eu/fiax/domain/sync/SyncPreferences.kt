package eu.fiax.domain.sync

import eu.fiax.domain.sync.models.SyncSettings
...
class SyncPreferences(
    ...
    fun clientHost() = preferenceStore.getString("sync_client_host", "https://sync.faxyomi.org")
